...
import kotlinx.android.synthetic.main.group_details_insert.view.*
 ...
 * @author ql
 */
class GroupDetailsInsertView : RelativeLayout, IGroupDetailsView {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        val cView = LayoutInflater.from(context).inflate(R.layout.group_details_insert, this)
    ...
    override fun setGroupName(name: String?) {
        groupDetailsNameEt.setText(name)
    }

    override fun setGroupCode(code: String?) {
        groupDetailsCodeEt.setText(code)
    }
    ...
    override fun getGroupName(): String? {
        return groupDetailsNameEt.text.toString()
    }

    override fun getGroupCode(): String? {
        return groupDetailsCodeEt.text.toString()
    }
}